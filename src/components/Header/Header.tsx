                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lmszt1vjmbbz15_tn'
                            alt='anh'
                            className='w-11 h-11 object-cover'
                          />
                        </div>
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>Bộ ga gối 3 món poly coton 1m6x2m và 1m8x2m hàng loại 1</div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫60.000</span>
                        </div>
                      </div>
                    </div>
                    <div className='mt-5'>
