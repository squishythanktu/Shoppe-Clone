...
export default function Header() {
  ...
  const { data: purcharsesInCartData } = useQuery({
    queryKey: ['purchases', { status: purchasesStatus.inCart }],
    queryFn: () => purchaseApi.getPurchases({ status: purchasesStatus.inCart })
  })

  const purchasesInCart = purcharsesInCartData?.data.data
          ...
          <Popover
            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col pr-28 pl-3'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-6 h-6 mr-2 flex-shrink-0'>
                <img
                  src='https://down-vn.img.susercontent.com/file/471606e7f4210c0fc64a4b1195503cd2_tn'
                  alt='avatar'
          ...
          <div className='col-span-1 justify-self-end'>
            ...
            >
              <Link to='/' className='relative'>
                ...
                {purchasesInCart && purchasesInCart.length > 0 && (
                  <span className='absolute top-[-5px] left-[17px] rounded-full px-[9px] py-[1px] bg-white text-xs text-orange'>
